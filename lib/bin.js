...
var addRepositories = function (resp) {
...
function WpkgBin (resp, callback) {
   ...
   */
  var run = function (args, lastArg, tmp, resp, callback, callbackStdout) {
  ...
  this._run = function (args, lastArg, callbackStdout) {
    xSubst.wrap (_tmp, resp, function (err, dest, callback) {
      run (args, lastArg, dest, resp, callback, callbackStdout);
    }, _callback);
  };
}
...
WpkgBin.prototype.build = function (repositoryPath, packagePath, arch) {
  ...
  args = args.concat (addRepositories (this._resp));
  args.push ('--build');
