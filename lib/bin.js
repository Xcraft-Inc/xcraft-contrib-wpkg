...
class WpkgBin {
  ...
  *isV1Greater(v1, v2, next) {
    const isV1Prerelease = /-(alpha|beta|rc|pre)[0-9]+/.test(v1);
    const isV2Prerelease = /-(alpha|beta|rc|pre)[0-9]+/.test(v2);

    if (isV1Prerelease && !isV2Prerelease) {
      v1 = v1.replace(/-[0-9]+$/, '');
      v2 = v2.replace(/-[0-9]+$/, '');
      v2 += '-stable';
    } else if (!isV1Prerelease && isV2Prerelease) {
      v1 = v1.replace(/-[0-9]+$/, '');
      v2 = v2.replace(/-[0-9]+$/, '');
      v1 += '-stable';
    }
